...
abstract class SkeletonFragment<VM : SkeletonViewModel<BaseViewState>, ParentVM : SkeletonViewModel<BaseViewState>, DataBinding : ViewDataBinding> : BaseFragment<VM, ParentVM, DataBinding>() {
